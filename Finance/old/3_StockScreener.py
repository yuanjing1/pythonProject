...
stocklist = pd.read_excel('..\data\RichardStocks.xlsx')
stocklist = stocklist.head()  # get the first 5 rows
...
print(exportList)
# exportList.to_csv('..\data\out_Screen.csv')
