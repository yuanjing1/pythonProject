...
stock = input("Enter the symbol symbol (enter 'quit' to stop): ") #Query user for symbol ticker
...
while stock != "quit": #Runs this loop until user enters 'quit' (can do many stocks in a row)
	...
	stock = input("Enter the symbol symbol (enter 'quit' to stop): ") #query user for next symbol